...
{
    float currentReward, alpha = 0.15;
    ...
    if (step > 7) //to prevent recursion to go too deep, without much effect.
        return 0; 
    ...
    for (size_t idx = 0; idx < (SIZE); ++idx)
    {
        ...
        //cout << "recursion!" << endl;
        reward += ((valueFunc(mazeGrid, step + 1, reward, idxPlusAction))/4);
    }
